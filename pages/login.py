    ...
    with center:
        ...
        if isAgree:
            if u and p and not st.session_state['auth']:
                ...
                status.warning('Username and Password cannot be empty')
...
def out():
    ...
    with center:
        st.markdown("<center><a style='text-align: center;'>Are you sure you want to go out?</a></center>", unsafe_allow_html=True)
