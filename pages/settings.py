...
def app():
    ...
    with c1:
        ...
        st.button("Create Schedule", on_click=changeAction(0))
    ...
    with c2:
        ...
        st.button('Modify Schedule', on_click=changeAction(0))
    ...
    with c3:
        ...
        st.button('Delete Schedule', on_click=changeAction(0))
